...
public class MoreFoodModItems {
	...
	public static Item MORE_FOOD_ICON;
	...
	public static void load() {
		...
		MORE_FOOD_ICON = Registry.register(Registry.ITEM, new ResourceLocation(MoreFoodMod.MODID, "more_food_icon"), new MoreFoodIconItem());
	}
}
